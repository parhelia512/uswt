		...
		void start_pass (jpeg_decompress_struct cinfo, int pass_mode) {
			...
			switch (pass_mode) {
				case JBUF_PASS_THRU:
					...
					break;
//				ZZPOUNDifdef QUANT_2PASS_SUPPORTED
...
//					ZZPOUNDifdef IDCT_SCALING_SUPPORTED
//					case 1:
...
//							ZZPOUNDifdef DCT_ISLOW_SUPPORTED
							case JDCT_ISLOW:
//								method_ptr = jpeg_idct_islow;
								method = JDCT_ISLOW;
								break;
//							ZZPOUNDendif
//							ZZPOUNDifdef DCT_IFAST_SUPPORTED
//							case JDCT_IFAST:
//								method_ptr = jpeg_idct_ifast;
//								method = JDCT_IFAST;
//								break;
//							ZZPOUNDendif
//							ZZPOUNDifdef DCT_FLOAT_SUPPORTED
//							case JDCT_FLOAT:
...
//					idct.inverse_DCT[ci] = method_ptr;
					...
					switch (method) {
//						ZZPOUNDifdef PROVIDE_ISLOW_TABLES
						case JDCT_ISLOW:
						{
...
//					break;
//				ZZPOUNDendif /* QUANT_2PASS_SUPPORTED */
					default:
						error();
//						ERREXIT(cinfo, JERR_BAD_BUFFER_MODE);
						break;
...
//	coef.pub.start_output_pass = start_output_pass;
	...
	if (need_full_buffer) {
//ZZPOUNDifdef D_MULTISCAN_FILES_SUPPORTED
...
//ZZPOUNDifdef BLOCK_SMOOTHING_SUPPORTED
...
//	}
//
//ZZPOUNDelse /* !IDCT_SCALING_SUPPORTED */
...
//ZZPOUNDendif /* IDCT_SCALING_SUPPORTED */
...
//ZZPOUNDifdef UPSAMPLE_MERGING_SUPPORTED
...
//ZZPOUNDifndef NO_ZERO_ROW_TEST
...
//ZZPOUNDifdef QUANT_1PASS_SUPPORTED
...
//		ERREXIT(cinfo, JERR_ARITH_NOTIMPL);
		...
		if (cinfo.progressive_mode) {
//ZZPOUNDifdef D_PROGRESSIVE_SUPPORTED
...
//		master.pass_number++;
//	}
//ZZPOUNDendif /* D_MULTISCAN_FILES_SUPPORTED */
}
